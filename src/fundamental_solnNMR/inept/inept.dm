...
The purpose of the @abrv{INEPT} sequence @sidenote{Morris GA, Freeman
...
large magnetization from high-@gamma nuclei, like @sup{1}H or @19F, to
low-@gamma nuclei (labeled 'X'), like @13C and @15N. This transfer
...
magnetization of @1H nuclei is roughly 4 times greater than @13C and
10 times greater than @15N. Additionally, the @1H @T1 is typically
much shorter than the @T1 for @13C or @15N, which allows a shorter
...
these are orthogonal to the x-phase of the pulse.@sidenote{
